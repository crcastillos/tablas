...
import { householdsApi } from "@/frontend/api/households.api";
import type { HouseholdMember } from "@/frontend/types/domain";
...
import { householdRoleLabel } from "@/frontend/utils/labels";
import { canManageMembers } from "@/frontend/utils/permissions";
...
export default function MembersPage() {
  ...
  return (
    <>
      ...
      <Paper>
        <Table>
          <TableHead><TableRow><TableCell>Nombre</TableCell><TableCell>Correo</TableCell><TableCell>Rol</TableCell><TableCell>Activo</TableCell></TableRow></TableHead>
          <TableBody>
            {members.map((member) => (
              <TableRow key={member.id}>
                ...
                <TableCell>{member.isActive ? "Si" : "No"}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
