...
import { budgetsApi, categoriesApi } from "@/frontend/api/budgets.api";
import type { BudgetSummary, ExpenseCategory } from "@/frontend/types/domain";
import { BudgetProgress, EmptyState, ErrorState, LoadingState, PageHeader } from "@/frontend/components/ui/States";
  ...
  return (
    <>
      <PageHeader
        ...
        action={!readonly ? <Button variant="contained" onClick={() => void save()}>Guardar presupuesto</Button> : undefined}
      />
      ...
      <Paper>
        <Table>
          <TableHead><TableRow><TableCell>Categoria</TableCell><TableCell align="right">Presupuesto</TableCell><TableCell align="right">Gastado</TableCell><TableCell>Consumo</TableCell></TableRow></TableHead>
          <TableBody>
      ...
      <Dialog open={confirmOpen} onClose={() => setConfirmOpen(false)}>
        ...
        <DialogContent><Typography>El presupuesto total supera el ingreso estimado. Desea continuar?</Typography></DialogContent>
        <DialogActions>
