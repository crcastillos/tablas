...
import { incomesApi } from "@/frontend/api/incomes.api";
import type { Income, IncomeType } from "@/frontend/types/domain";
...
import { IncomeStatus, PeriodStatus } from "@/frontend/types/domain";
import { incomeStatusLabel } from "@/frontend/utils/labels";
...
export default function IncomesPage() {
  ...
  return (
    <>
      <PageHeader title="Ingresos del mes" action={!readonly ? <Button variant="contained" onClick={() => setOpen(true)}>Nuevo ingreso</Button> : undefined} />
      ...
      <Paper>
        <Table>
          <TableHead>
            <TableRow>
              <TableCell>Tipo</TableCell><TableCell>Descripcion</TableCell><TableCell align="right">Estimado</TableCell>
              <TableCell align="right">Recibido</TableCell><TableCell>Estado</TableCell><TableCell />
            </TableRow>
          </TableHead>
          <TableBody>
            {items.map((income) => (
